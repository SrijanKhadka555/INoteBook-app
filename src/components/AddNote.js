               ...
               <div className="container my-3">
                    ...
                    <form className="my-3">
                         <div className="mb-3">
                              ...
                              <input type="text" className="form-control" id="title" name='title' value={note.title} aria-describedby="emailHelp" onChange={onchange} minLength={5} maxLength={15} required />
                         </div>
                         <div className="mb-3">
